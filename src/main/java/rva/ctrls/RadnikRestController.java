...
public class RadnikRestController {
	...
	@ApiOperation(value = "Vraæa radnika po ID radnika")
	...
	@ApiOperation(value = "Vraæa radnike po ID sektora")
	...
	@ApiOperation(value = "Vraæa radnike po ID obrazovanja")
	...
	@ApiOperation(value = "Vraæa radnike po imenu radnika")
	...
	@PutMapping("radnik")
	@ApiOperation(value = "Ažurira postojeæeg radnika")
	...
	@ApiOperation(value = "Briše postojeæeg radnika")
