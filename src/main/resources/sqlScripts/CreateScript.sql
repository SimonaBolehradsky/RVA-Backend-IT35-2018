...
ALTER TABLE radnik ADD CONSTRAINT fk_radnik_obrazovanje FOREIGN KEY(obrazovanje) REFERENCES (id);
ALTER TABLE radnik ADD CONSTRAINT fk_radnik_sektor FOREIGN KEY(sektor) REFERENCES (id);
ALTER TABLE sektor ADD CONSTRAINT fk_sektor_preduzece FOREIGN KEY(preduzece) REFERENCES (id);
